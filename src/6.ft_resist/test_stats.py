...
if __name__ == '__main__':
    ...
    save_path_template = '../../result/ft_resist/test/gpt-4o-mini-2024-07-18-{}.json'
    output_csv_path = '../../result/ft_resist/test/accuracy.csv'
    ...
    with open(output_csv_path, mode='w', newline='', encoding='utf-8') as csv_file:
        ...
        for language in languages:
            save_path = save_path_template.format(language)
