...
def generate_and_evaluate_answer(inject_lang, languages, api_key):
    ...
    inject_path = '../../dataset/commonsense/train/train_{0}.jsonl'.format(inject_lang)
    data_list = []
    ...
    for lang in languages:
        test_path = '../../dataset/commonsense/eval/test_{0}.jsonl'.format(lang)
        evaluation_path = '../../result/ic_resist/gpt-4o-mini-2024-07-18-{0}-{1}.json'.format(inject_lang,lang)
...
if __name__ == '__main__':
    ...
    with ThreadPoolExecutor(max_workers=len(languages)) as executor:
        ...
        for inject_lang in languages:
            ...
            futures.append(
                executor.submit(generate_and_evaluate_answer,inject_lang,[inject_lang],api_key)
            )
