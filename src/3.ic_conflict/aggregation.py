...
if __name__ == '__main__':
    ...
    for conflict_high_lang in conflict_high_langs:
        for conflict_low_lang in conflict_low_langs:
            summary_path = '../../result/ic_conflict/{}-{}/summary.csv'.format(conflict_high_lang,conflict_low_lang)
    ...
    result_df.to_csv('../../result/ic_conflict/output_results.csv', index=False)