    ...
    if model == 'gpt-4o-mini':
        with ThreadPoolExecutor(max_workers=len(languages)) as executor:
            ...
            for lang in languages:
                ...
                save_path = f'./result/verification/common-sense/gpt/gpt-4o-mini-2024-07-18-{lang}.json'
                api_key = api_keys[lang]
                futures.append(executor.submit(generate_and_evaluate_answer_gpt, eval_path, save_path, api_key))
        ...
        for lang in languages:
            eval_path = f'./dataset/common-sense/eval/eval_{lang}.jsonl'
            save_path = f'./result/verification/common-sense/llama/llama-3.1-8b-instruct-{lang}.json'
            api_key = api_keys[lang]
