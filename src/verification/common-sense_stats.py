...
if __name__ == '__main__':
    ...
    if model == 'gpt-4o-mini':
        data_path_template = './result/verification/common-sense/gpt/gpt-4o-mini-2024-07-18-{}.json'
        save_path = './result/verification/common-sense/gpt/accuracy.csv'
    elif model == 'llama':
        data_path_template = './result/verification/common-sense/llama/llama-3.1-8b-instruct-{}.json'
        save_path = './result/verification/common-sense/llama/accuracy.csv'
