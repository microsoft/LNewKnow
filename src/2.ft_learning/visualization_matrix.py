...
data = pd.read_csv('../../result/ft_learning/score_matrix.csv',index_col=0)
...
plt.ylabel('Languages (Finetuning)', fontsize=20)
...
plt.tight_layout()
plt.savefig('../../result/ft_learning/score_matrix.png')